                ...
                <div key={game.id} className="checkoutItem">
                  <div className="checkoutGame">
                    <div className="checkoutGameImgContainer">
                      <img src={game.url} alt="" className="checkoutGameImg" />
                    </div>

                    <div className="checkoutGameInfo">
                      <span className="checkoutGameTitle">{game.title}</span>
                      <span className="checkoutGamePrice">
                        ${game.salePrice || game.originalPrice}
                      </span>
                      <button
                        onClick={() => removeItem(game)}
                        className="checkoutGameRemove"
                      >
                        Remove
                      </button>
                    </div>
                  ...
                  <div className="checkoutTotal">
                    $
                    {(
                      game.quantity * (game.salePrice || game.originalPrice)
                    ).toFixed(2)}
                  </div>
                </div>
              );
